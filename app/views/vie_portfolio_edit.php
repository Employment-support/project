...
<body>
    ...
    <h1 class="text-align-center">ポートフォリオ-編集</h1>
    <form action="" method="POST" enctype="multipart/form-data">

        <p><label for="image">画像投稿<br><input type="file" id="image" name="image"></label></p>
        <p><label for="url">URL<br><input type="text" style="width: 500px; height: 20px;" id="url" name="url" value="<?= $portfolio_data['item_url'] ?>"></label></p>
        <p><label for="title">タイトル<br><input type="text" style="width: 500px; height: 20px;" id="title" name="title" value="<?= $portfolio_data['title'] ?>"></label></p>
        <p><label for="text">文章<br>
        <!-- <input type="text" style="width: 500px; height: 600px;" id="text" name="text" required> -->
        <textarea style="width: 500px; height: 600px;" id="text" name="text"  cols="30" rows="10" required><?= $portfolio_data['contents'] ?></textarea>
    </label></p>
