...
<nav>
	<ul>
		...
		<li><a href="vie_share_list.php">共有情報</a></li>
		<li><a href="#">企業説明</a></li>
		<li><a href="vie_resume_create.php">履歴書作成</a></li>
		<li><a href="vie_create_portfolio.php">ポートフォリオ作成</a></li>
		<li class="right"><a href="vie_login.php" class="contact">ログイン</a></li>
	</ul>
	<hr>
</nav>